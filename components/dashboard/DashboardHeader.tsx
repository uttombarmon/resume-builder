    ...
    <header className="h-20 border-b bg-white dark:bg-slate-900 px-6 flex items-center justify-between transition-colors duration-300 relative z-10">
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            render={
              <Button variant="ghost" className="flex items-center gap-2 p-1 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-transparent outline-none cursor-pointer">
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-2xl p-2 mt-2">
            ...
            <DropdownMenuItem 
                onClick={() => signOut()}
                className="rounded-xl font-bold gap-3 cursor-pointer py-2.5 text-red-600 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-900/20"
            >
                Sign Out
            </DropdownMenuItem>
          </DropdownMenuContent>
